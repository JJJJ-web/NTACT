...
import {Home, FinalCart, Menu, Payment, PaymentResult, PaymentSuccess, PaymentHistory, PaymentDetail, MenuManage, Login, Shop} from './index';
...
const Router = () => (
    <Switch>
        ...
        <Route exact path="/payment/history_details" component={PaymentDetail} />
